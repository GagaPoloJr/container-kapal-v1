<div>
    ...
    <div class="row">
        ...
        <div class="col-12 mt-2 col-md-2">
            ...
            <x-form-input name="barangFields.{{ $formField['id'] }}.{{ $loop->index }}.attributes.jml_barang" id="barangFields.{{ $formField['id'] }}.{{ $loop->index }}.attributes.jml_barang" type="text" class="mt-1  block w-full" wire:model="barangFields.{{ $formField['id'] }}.{{ $loop->index }}.attributes.jml_barang" autocomplete="jml_barang" />
        ...
        <div class="col-12 mt-2 col-md-2">
            <x-form-label required='true' for="kg" label="{{ __('Kg') }}" :required="true" />
